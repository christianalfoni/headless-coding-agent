...
export function str_replace_based_edit_tool(workingDirectory) {
    return {
        ...
        input_schema: {
            ...
            properties: {
                ...
                view_range: {
                    ...
                    minItems: 2,
                    maxItems: 2,
                    description: "Start and end line numbers for view command [start, end] (1-based indexing, end exclusive). Use [1, 3] to show lines 1 and 2, [2, 5] to show lines 2, 3, and 4.",
                },
            },
            required: ["command", "path"],
        },
        execute: async ({ command, path: filePath, file_text, insert_line, new_str, old_str, view_range, }) => {
            try {
                ...
                switch (command) {
                    ...
                    case "create":
                        ...
                        return `File '${filePath}' created successfully with ${file_text.split("\n").length} lines.`;
                    case "str_replace":
