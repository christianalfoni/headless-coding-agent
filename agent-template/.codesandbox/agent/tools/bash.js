...
export function bash(workingDirectory) {
    return {
        id: "anthropic.bash_20250124",
        name: "bash",
        description: `Execute bash commands in a non-interactive shell session on ${process.platform} (${os.release()}). Working directory: ${workingDirectory}. Each command runs in a fresh shell starting from this directory. Use non-interactive flags for commands that normally prompt for input (e.g., --yes, --force, --no-input).`,
        input_schema: {
            type: "object",
            properties: {
                command: {
