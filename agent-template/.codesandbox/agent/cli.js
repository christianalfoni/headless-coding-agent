...
function parseArgs() {
    ...
    if (!prompt) {
        console.error('Usage: agent --prompt "your prompt here" [--format] [--maxSteps <number>] [--provider <string>] [--todos <json>]');
        ...
        console.error("  --provider: AI provider to use: anthropic, openai, or together (default: anthropic)");
